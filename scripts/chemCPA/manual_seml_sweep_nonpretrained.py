...
if __name__ == "__main__":
    ...
    cur_path = os.getcwd()
    assert Path(os.path.join(cur_path, "config_sciplex_rdkit_nonpretrained.yml")).exists(), "config file not found"
    seml_config, slurm_config, experiment_config = read_config(os.path.join(cur_path, "config_sciplex_rdkit_nonpretrained.yml"))
