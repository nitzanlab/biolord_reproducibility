...
def train_dataset():
    ...
    varying_arg["adata"] = sc.read(os.path.join(DATA_DIR, "perturbation/sciplex3_biolord.h5ad"))
    ...
    module_params = {
        "autoencoder_width": varying_arg["autoencoder_width"],
        "autoencoder_depth": varying_arg["autoencoder_depth"],
        ...
        "loss_ordered_attribute": varying_arg["loss_ordered_attribute"],
    ...
    trainer_params = {
        "n_epochs_warmup": 0,
        "autoencoder_lr": varying_arg["autoencoder_lr"],
        "autoencoder_wd": varying_arg["autoencoder_wd"],
