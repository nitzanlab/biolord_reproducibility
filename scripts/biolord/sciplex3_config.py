...
varying_arg = {
    ...
    "autoencoder_width": np.random.choice([128, 256, 512, 1024, 2048, 4096]),
    "autoencoder_depth": np.random.choice([1, 2, 3, 4, 6, 8]),
    ...
    "loss_ordered_attribute": np.random.choice(["gauss", "mse"]),
    ...
    "autoencoder_lr": np.random.choice([1e-2, 1e-3, 1e-4]),
    "autoencoder_wd": np.random.choice([1e-2, 1e-3, 1e-4]),
